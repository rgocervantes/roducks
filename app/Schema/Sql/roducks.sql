...
CREATE TABLE IF NOT EXISTS `Setup` (
  `id_setup` bigint(8) AUTO_INCREMENT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `EAV` (
  `id_index` bigint(8) AUTO_INCREMENT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Roles` (
  `id_role` bigint(8) AUTO_INCREMENT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Users` (
  `id_user` bigint(8) AUTO_INCREMENT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Urls` (
  `id_url` bigint(8) AUTO_INCREMENT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `UrlsLang` (
  `id_url_lang` bigint(8) AUTO_INCREMENT UNSIGNED NOT NULL,
